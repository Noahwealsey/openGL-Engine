...
Lighting::Lighting() {
    ...
    m_pointLightPositions[0] = glm::vec3(0.7f, 4.2f, 2.0f);
    m_pointLightPositions[1] = glm::vec3(2.3f, 5.3f, -4.0f);
    m_pointLightPositions[2] = glm::vec3(-4.0f, 5.0f, -12.0f);
    m_pointLightPositions[3] = glm::vec3(0.0f, 3.0f, -3.0f);
